...
- Pick another "generating process" distribution, and show that the CLT applies to this as well, using simulations. Try using all of the "technologies" we've discussed so far.
