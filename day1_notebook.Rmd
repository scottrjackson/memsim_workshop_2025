...
- Using some of the functions we've used here, along with either a loop or the `replicate()` function, use simulations to see how the Central Limit Theorem works in action.
- In other words:
...
```{r}
die_roll_averages <- replicate(20000, 
                               mean(sample(1:6, 1000, replace = TRUE)))

ggplot(data = NULL, aes(die_roll_averages)) + geom_histogram()
